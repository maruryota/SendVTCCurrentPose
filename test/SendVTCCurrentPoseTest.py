...
"""
 @file SendVTCCurrentPoseTest.py
...
sendvtccurrentposetest_spec = ["implementation_id", "SendVTCCurrentPoseTest",
		 "type_name",         "SendVTCCurrentPoseTest",
...
##
# @class SendVTCCurrentPoseTest
# @brief ModuleDescription
#
#
class SendVTCCurrentPoseTest(OpenRTM_aist.DataFlowComponentBase):
...
def SendVTCCurrentPoseTestInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=sendvtccurrentposetest_spec)
    manager.registerFactory(profile,
                            SendVTCCurrentPoseTest,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    SendVTCCurrentPoseTestInit(manager)

    # Create a component
    comp = manager.createComponent("SendVTCCurrentPoseTest")
